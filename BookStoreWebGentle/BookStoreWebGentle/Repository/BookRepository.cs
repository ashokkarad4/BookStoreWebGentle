...
namespace BookStoreWebGentle.Repository
{
    public class BookRepository
    {
        ...
        private List<BookModel> DataSource()
        {
            ...
            {
                new BookModel(){Id=1,Title="MVC",Author="Ashok",Description="This is the descrption of MVC Book",Category="Programming",Language="English",TotalPages="452"},
                new BookModel(){Id=2,Title="C#",Author="Deepak",Description="This is the descrption of C# Book",Category="Developer backend",Language="English",TotalPages="500"},
